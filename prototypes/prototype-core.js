...
const cfg={
 ...
 /* Exactly 42 letters. The Orb runtime places these in a prevalidated order
    where every next letter is unique among the current tile's neighbours. */
 orb:{name:'Word Orb',words:['ROUND','VENUS','COMET','ARC','PLUTO','CURVE','GLOBE','MOON','WORLD'],rx:-18,ry:-30,route:'Geodesic'},
